                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="stats-counter">
                                    <?php
                                    $eid = $_SESSION['eid'];
                                    $sql = "SELECT id from tblemployees where Department IN (SELECT Department FROM tblemployees WHERE tblemployees.id=:eid)";
                            ...
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where Department IN (SELECT Department FROM tblemployees WHERE tblemployees.id=:eid) order by lid desc limit 6";
                                        $query = $dbh->prepare($sql);
                                        $query->bindParam(':eid', $eid, PDO::PARAM_STR);
                                        $query->execute();
                                        $results = $query->fetchAll(PDO::FETCH_OBJ);
