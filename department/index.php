...
$sql ="SELECT EmailId,Password,Department,Status,id,Roles FROM tblemployees WHERE EmailId=:uname  and Password=:password and Department=:department and Roles='HOD'";
...
$_SESSION['dpmlogin']=$_POST['username'];
                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Department Login</span>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="input-field col s12">
                                                        ...
                                                        <p class="deep-purple-text lead"><a href="forgot-password.php">Forgot Pasword ?</a></p>
                                                        </div>
