                        ...
                        <div class="card-content">
                            ...
                            <table id="example" class="display responsive-table ">
                                ...
                                <tbody>
                                    <?php
                                    $eid = $_SESSION['eid'];
                                    $sql = "SELECT EmpId,FirstName,LastName,Department,Roles,Status,RegDate,id from  tblemployees WHERE Department IN (SELECT Department FROM tblemployees WHERE tblemployees.id=:eid)";
                                    $query = $dbh->prepare($sql);
