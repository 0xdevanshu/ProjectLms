     <aside id="slide-out" class="side-nav white fixed">
         <div class="side-nav-wrapper">
                     ...
                     <?php
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results as $result) {               ?>
                             ...
                             <p><?php echo htmlentities("Department of ". $result->Department); ?></p>
                     <?php }
                        } ?>
                 </div>
             </div>
             ...
             <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                 ...
                 <li class="no-padding">
                     <a class="waves-effect waves-grey" href="myprofile.php"><i class="material-icons">account_box</i>My
                         Profiles</a></li>
                 <li class="no-padding">
                     ...
                     <div class="collapsible-body">
                         <ul>
                             <li><a href="listfaculty.php">View Faculty</a></li>
                         </ul>
                     </div>
                 </li>
                 <li class="no-padding">
                     <a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Chnage Password</a></li>
                 <li class="no-padding">
                     <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">add_to_queue</i>Leave Management<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                     <div class="collapsible-body">
                         <ul>
             ...
             <div class="footer">
                 <p class="copyright"><a href="http://secs.ac.in/">SGI, Sikar </a></p>
