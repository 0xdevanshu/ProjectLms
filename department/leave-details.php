...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        date_default_timezone_set('Asia/Kolkata');
        // $admremarkdate = date('Y-m-d G:i:s ', strtotime("now"));
        $sql = "update tblleaves set HodRemark=:description,Status=:status where id=:did";
        $query = $dbh->prepare($sql);
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5"><?php $stats = $result->Status;
                                                                if ($stats == 3) {
                                                                ?>
                                                        <span style="color: green">Waiting for admin approval</span>
                                                    <?php }
                                                                if ($stats == 1) {
                                                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2"><?php
                                                                ...
                                                                ?></td>
                                                <td style="font-size:16px;"><b>Head of Department Remark: </b></td>
                                                <td colspan="2"><?php
                                                                if ($result->HodRemark == "") {
                                                                    echo "waiting for Approval";
                                                                } else {
                                                        ...
                                                        <form name="adminaction" method="post">
                                                            <div id="modal1" class="modal modal-fixed-footer" style="height: 60%">
                                                                <div class="modal-content" style="width:90%">
                                                                    ...
                                                                    <p><textarea id="textarea1" placeholder="Ex: Best of Luck!" class="materialize-textarea" name="description" length="500" maxlength="500" required></textarea></p>
                                                                </div>
